...
<head>
    ...
    <meta name="author" content="Inovatik">
    	...
    	<meta property="og:site_name" content="" /> 	<meta property="og:site" content="" /> 	<meta property="og:title" content=""/> 	<meta property="og:description" content="" /> 	<meta property="og:image" content="" /> 	<meta property="og:url" content="" /> 	<meta property="og:type" content="article" />
...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
                        ...
                        <a class="navbar-brand logo-image" href="index.html"><img src="landing/images/logo.svg" alt="alternative"></a> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        ...
                        </div>                     </div>                     <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="landing/images/header-software-app.png" alt="alternative">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-image">
                            <img class="img-fluid" src="landing/images/description-1.png" alt="alternative">
                        </div>
                        <div class="card-body">
                            ...
                            <p>It's very easy to start creating email lists for your marketing actions. Just create your Tivo account</p>
                                        ...
                                        <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="landing/images/description-2.png" alt="alternative">
                        </div>
                        <div class="card-body">
                            ...
                            <p>Campaigns is a feature we've developed since the beginning because it's at the core of Tivo's functionalities</p>
                                        ...
                                        <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="landing/images/description-3.png" alt="alternative">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-12">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="landing/images/features-1.png" alt="alternative">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="landing/images/features-2.png" alt="alternative">
                                    </div>                                 </div>                                 <div class="col-lg-6">
                                    <div class="text-container">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="landing/images/features-3.png" alt="alternative">
                                    </div>                                 </div>                                 <div class="col-lg-6">
                                    <div class="text-container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="landing/images/details-lightbox.png" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="image-container">
                        <img class="img-fluid" src="landing/images/details.png" alt="alternative">
                    </div>                 </div>             </div>         </div>     </div>     
                ...
                <div class="col-lg-12">
                        ...
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="landing/images/video-image.png" alt="alternative">
                        ...
                        <div class="swiper-container text-slider">
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="landing/images/testimonial-1.jpg" alt="alternative">
                                        ...
                                        <div class="testimonial-author">Jude Thorn - Online Marketer</div>
                                                                ...
                                                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="landing/images/testimonial-2.jpg" alt="alternative">
                                    </div>                                     <div class="text-wrapper">
                                        ...
                                        <div class="testimonial-author">Roy Smith - Developer</div>
                                                                ...
                                                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="landing/images/testimonial-3.jpg" alt="alternative">
                                    </div>                                     <div class="text-wrapper">
                                        ...
                                        <div class="testimonial-author">Marsha Singer - Online Marketer</div>
                                                                ...
                                                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="landing/images/testimonial-4.jpg" alt="alternative">
                                    </div>                                     <div class="text-wrapper">
        ...
        <script src="landing/js/jquery.min.js"></script>     <script src="landing/js/popper.min.js"></script>     <script src="landing/js/bootstrap.min.js"></script>     <script src="landing/js/jquery.easing.min.js"></script>     <script src="landing/js/swiper.min.js"></script>     <script src="landing/js/jquery.magnific-popup.js"></script>     <script src="landing/js/validator.min.js"></script>     <script src="landing/js/scripts.js"></script> </body>
</html>